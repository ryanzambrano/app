    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.textContainer}>
        ...
        <Text style={styles.text}>
          By accessing and using the Cabaná app, you agree to be bound by the
        ...
        <Text style={styles.text}>
          Cabaná reserves the right to change, modify, or update these terms at
        ...
        <Text style={styles.text}>
          All content on Cabaná, including text, graphics, logos, and software,
          is the property of Cabaná or its licensors and protected by
        ...
        <Text style={styles.text}>
          ...
          use of Cabaná will be governed by the laws of [Jurisdiction].
        </Text>
        ...
        <Text style={styles.text}>
          Cabaná is provided "as is" and without warranties of any kind. We do
          not guarantee that Cabaná will be available at all times or that it
          will meet your needs.
        </Text>

        <Text style={styles.heading}>8. Indemnification</Text>
        <Text style={styles.text}>
          You agree to indemnify and hold harmless Cabaná, its affiliates,
        ...
        <Text style={styles.text}>
          Cabaná reserves the right to suspend or terminate your account at any
          time for any reason.
        </Text>
